...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.kerriline.location.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.kerriline.location.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.kerriline.location.domain.User.class.getName());
            ...
            createCache(cm, com.kerriline.location.domain.MileageResponse.class.getName());
