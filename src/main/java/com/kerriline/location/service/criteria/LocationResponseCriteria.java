...
public class LocationResponseCriteria implements Serializable, Criteria {
    ...
    private LocalDateFilter responseDatetime;
    ...
    public LocalDateFilter getResponseDatetime() {
        return responseDatetime;
    }

    public LocalDateFilter responseDatetime() {
        if (responseDatetime == null) {
            responseDatetime = new LocalDateFilter();
        }
        return responseDatetime;
    }

    public void setResponseDatetime(LocalDateFilter responseDatetime) {
