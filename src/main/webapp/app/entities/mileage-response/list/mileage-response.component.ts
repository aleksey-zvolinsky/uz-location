...
export class MileageResponseComponent implements OnInit {
  ...
  protected onSuccess(data: IMileageResponse[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    if (navigate) {
      this.router.navigate(['/mileage-response'], {
        queryParams: {
          page: this.page,
          size: this.itemsPerPage,
