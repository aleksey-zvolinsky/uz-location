  ...
  describe('Tank Management Update Component', () => {
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', () => {
        // GIVEN
        const saveSubject = new Subject<HttpResponse<Tank>>();
        const tank = { id: 123 };
        jest.spyOn(tankService, 'update').mockReturnValue(saveSubject);
      ...
      it('Should call create service on save for new entity', () => {
        ...
        const saveSubject = new Subject<HttpResponse<Tank>>();
        const tank = new Tank();
        jest.spyOn(tankService, 'create').mockReturnValue(saveSubject);
        jest.spyOn(comp, 'previousState');
        activatedRoute.data = of({ tank });
        comp.ngOnInit();
